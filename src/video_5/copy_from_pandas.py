...
person_df = pd.read_parquet("data/parquet/person.parquet")
product_df = pd.read_parquet("data/parquet/product.parquet")
purchased_df = pd.read_parquet("data/parquet/purchased.parquet")
